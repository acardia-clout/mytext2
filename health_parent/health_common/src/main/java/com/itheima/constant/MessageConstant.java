...
public class MessageConstant {
    ...
    public static final String GET_SETMEAL_REPORT_SUCCESS = "获取套餐预约占比饼图统计数据成功";
    public static final String GET_SETMEAL_REPORT_FAIL = "获取套餐预约占比饼图统计数据失败";
    ...
    public static final String ERROR_CHECKITEM_CHECKGROUP = "当前检查项和检查组存在关系，不能删除";
    public static final String ERROR_CHECKGROUP_SETMEAL = "当前检查组和套餐存在关系，不能删除";
}
